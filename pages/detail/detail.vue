		...
		<view class="box" v-if="orders.id">
			...
			<view class="line">
				...
				<view class="line-content">
					<image v-if="orders.img" :src="orders.img" mode="widthFix" style="width: 180rpx;"></image>
					<text v-else>无</text>
				</view>
			</view>
			<view class="line">
			...
			<view class="line">
				...
				<view class="line-content">{{ orders.weight || 0 }} kg</view>
			</view>
			<view class="line">
				<view class="line-title">所需金豆：</view>
			...
			<view class="line">
				...
				<view class="line-content">
					<image v-if="orders.certification && orders.certification.avatar" :src="orders.certification.avatar" mode="widthFix" style="width: 180rpx;"></image>
				</view>
			</view>
		...
		methods: {
			...
			load(orderId) {
				this.$request.get('/orders/selectById/' + orderId).then(res => {
					this.orders = res.data || { address: {}, targetAddress: {}, certification: {} }
				})
			}
		}
	}
